...
export default function AddNewProjectComponent({values}) {
  const [projects, setProjects] = useState([]); // Store multiple projects
  values(projects)
            ...
            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  >
                    <option defaultValue="null">Select Progress</option>
